...
#SBATCH --output=inc.%A_%a.out          #writes standard output to "inc.JobID.out".
#SBATCH --error=inc.%A_%a.err           #writes error output to "inc.JobID.out".
#SBATCH --array=1-10%9

bash increment.sh $SLURM_ARRAY_TASK_ID $1
