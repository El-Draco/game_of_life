...
#SBATCH --job-name=Hello                #sets the name of the job as "hello".
...
#SBATCH --output=Hello.%j.out           #writes standard output to "Hello.JobID.out".
#SBATCH --error=Hello.%j.err            #writes error output to "Hello.JobID.out".
